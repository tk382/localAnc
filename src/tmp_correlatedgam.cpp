...
Rcpp::Function corr_gam_prior_c = Environment::global_env()["corr_gam_prior"];

//// [[Rcpp::depends("RcppArmadillo")]]
//// [[Rcpp::export]]
//double callFunction(arma::vec gam, arma::mat Sigma, Function f) {
//  double res = f(gam, Sigma);
//  return res;
//}
...
arma::vec get_target_c(const arma::vec X,
  ...
  G = as<double>(corr_gam_prior_c(gam, Sigma));

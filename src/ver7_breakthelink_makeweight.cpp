...
arma::vec betagam_accept_random_c(const arma::vec X,
                                  ...
                                  const int bb,
                                  const double observedratio){
  double newtarget = sum(get_target_c(X,Y,sigmabeta1,inputSigma,gam2,beta2, aa, bb, observedratio));
  double oldtarget = sum(get_target_c(X,Y,sigmabeta1,inputSigma,gam1,beta1, aa, bb, observedratio));
